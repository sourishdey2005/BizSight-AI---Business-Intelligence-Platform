...
# ============================================================
# CUSTOM CSS - PROFESSIONAL THEME (MERGED BEST OF BOTH)
# ============================================================
st.markdown("""
<style>
/* Main Header */
...
def load_model():
    try:
        ...
        st.sidebar.error(f"⚠️ Model loading error: {str(e)}. Using analytics mode.")
        return create_mock_model()
...
# ============================================================
# ADVANCED VISUALIZATION FUNCTIONS (20+ CHARTS)
# ============================================================
...
def create_sankey_diagram(df):
    ...
    fig = go.Figure(data=[go.Sankey(
        node=dict(
            ...
            label=stages,
            color=[COLOR_PALETTE['primary'], COLOR_PALETTE['secondary'], COLOR_PALETTE['success'], 
                  COLOR_PALETTE['purple'], COLOR_PALETTE['pink']]
        ),
        link=dict(
            source=[0, 1, 2, 3],
            target=[1, 2, 3, 4],
...
st.markdown("""
<p class='sub-header'>
Enterprise-grade analytics platform with 50+ metrics and 20+ advanced visualizations for data-driven decision making
</p>
""", unsafe_allow_html=True)
...
<div class='footer'>
    ...
    <p style='font-size: 1rem; color: #4B5563; margin: 1rem 0;'>
       Version 7.0 | 50+ Metrics | 20+ Advanced Visualizations | AI-Powered Analytics
    </p>
    ...
    <p style='font-size: 0.8rem; color: #D1D5DB; margin-top: 0.5rem;'>
       Requirements: streamlit>=1.32.0, pandas>=2.1.0, numpy>=1.26.0, plotly>=5.20.0, joblib>=1.3.2, 
