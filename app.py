...
if not uploaded_file and not use_sample_data:
    ...
    st.stop()
# Data source selection from second code
st.sidebar.markdown("---")
st.sidebar.markdown("### 📊 Data Source Selection")
data_source = st.sidebar.radio(
    "Choose data source:",
    ["Use uploaded/sample data", "Use advanced sample dataset"],
    index=0,
...
# Sidebar filters from first code
st.sidebar.markdown("---")
...
if use_sample_data or uploaded_file:
    ...
    performance_filter = st.sidebar.multiselect(
        ...
        ["All", "Poor", "Below Avg", "Average", "Good", "Excellent"],
        default=["All"]
    )
# ============================================================
...
if data_source == "Use advanced sample dataset":
    df_raw = load_data(sample=True, advanced_sample=True)
    st.sidebar.success("Using advanced sample data with 50,000 records")
...
# Apply additional filters from second code
...
if st.session_state.page == 'landing':
    ...
    <div class='welcome-message'>
        ...
        <p style='font-size: 1.2rem; margin-bottom: 2rem;'>Your Advanced Business Intelligence Platform for Predictive Analytics and Strategic Insights</p>
        <div class='feature-grid'>
            <div class='feature-item'>
                <div class='feature-icon'>📊</div>
                <h4>Comprehensive Dashboards</h4>
                <p>48+ interactive visualizations for deep insights</p>
            </div>
            <div class='feature-item'>
                <div class='feature-icon'>🤖</div>
                <h4>Predictive Modeling</h4>
                <p>AI-powered profit forecasting and risk assessment</p>
            </div>
            <div class='feature-item'>
                <div class='feature-icon'>🚀</div>
                <h4>Business Simulation</h4>
                <p>Real-time scenario analysis and optimization</p>
            </div>
            <div class='feature-item'>
                <div class='feature-icon'>📈</div>
                <h4>Strategic Recommendations</h4>
                <p>Data-driven decisions for business growth</p>
            </div>
        </div>
    </div>
    """, unsafe_allow_html=True)
    ...
    <div style='text-align: center; margin: 2rem 0;'>
        <p style='font-size: 1.1rem; color: #6B7280;'>Powered by Streamlit, Plotly, and Machine Learning</p>
        <p style='font-size: 0.9rem; color: #9CA3AF;'>Developed by Sourish Dey | © 2024 All rights reserved.</p>
    </div>
    """, unsafe_allow_html=True)
    ...
    st.divider()
    # ============================================================
    # EXPANDED EXECUTIVE SUMMARY - FROM FIRST CODE
    # ============================================================
